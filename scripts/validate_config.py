#!/usr/bin/env python3
"""Validate Codex Loop project profiles and run contracts without dependencies."""
...
PROFILE_KIND = "codex-loop/project-profile"
CONTRACT_KIND = "codex-loop/run-contract"
