#!/usr/bin/env python3
"""Validate Sol-Luna profiles and contracts without dependencies."""
...
PROFILE_KIND = "codex-herdr-sol-luna/project-profile"
CONTRACT_KIND = "codex-herdr-sol-luna/run-contract"
...
def _contract(document: dict[str, Any], errors: list[str]) -> None:
    required = {
        ...
        "tests_allowed", "luna_mode", "validation", "evidence", "budgets",
